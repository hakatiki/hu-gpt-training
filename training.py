...
tokenizer = AutoTokenizer.from_pretrained("hakatiki/hu-gpt")
config = AutoConfig.from_pretrained("hakatiki/hu-gpt", vocab_size=len(tokenizer))
...
def create_dataloaders():
    ...
    #                                 seed=args.seed)
    valid_data = load_dataset("data/validation",split="validation",streaming=True,)
...
model = AutoModelForCausalLM.from_pretrained("hakatiki/hu-gpt")
tokenizer = AutoTokenizer.from_pretrained("hakatiki/hu-gpt")

# Load dataset and dataloader
# TODO might need to fix it
